...
This project presents the complete design and simulation of a custom **6-bit CPU architecture** developed as part of the **CSE 3203 Computer Architecture CT-4 Assignment**. The CPU includes a fully functional **ALU**, **Register Set**, **RAM**, **Instruction Set Architecture (ISA)**, and **Control Unit**.
